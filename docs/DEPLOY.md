...
2. Cadastre `NEXT_PUBLIC_SITE_URL`, `NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY` e `SUPABASE_SECRET_KEY` em Development, Preview e Production. Mantenha `NEXT_PUBLIC_GOOGLE_AUTH_ENABLED=false` até configurar o Google no Supabase.
